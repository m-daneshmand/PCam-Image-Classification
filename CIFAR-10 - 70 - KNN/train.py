...
class Training:
    ...
    def __init__(self, model, data_loader, batch_size=10, epochs=20, saved_weights='model/saved_weights'):
        self.model = model
    ...
    def train_model(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            self.model.save_model(self.saved_weights + '.pth')

            pickle.dump(self.train_stats, open(self.saved_weights + '_stats.pkl', 'wb'))
